...
/**!
  ...
  */function f(e){return(e=e||{}).baseUrl=e.baseUrl||"",e.method&&e.url?h(e.method,e.baseUrl+e.url,v(e.data),e):["get","post","put","delete"].reduce((function(t,n){return t[n]=function(t,o){return h(n,e.baseUrl+t,v(o),e)},t}),{})}function v(e){return e||null}function h(e,t,n,o){var r=["then","catch","always"].reduce((function(e,t){return e[t]=function(n){return e[t]=n,e},e}),{}),a=new XMLHttpRequest,s=function(e,t,n){if("get"!==n.toLowerCase()||!t)return e;var o=function(e){return g(e)?function e(t,n){return Object.keys(t).map((function(o){if(t.hasOwnProperty(o)&&void 0!==t[o]){var r=t[o];return o=n?n+"["+o+"]":o,null!==r&&"object"===m(r)?e(r,o):w(o)+"="+w(r)}})).filter(Boolean).join("&")}(e):e}(t),r=e.indexOf("?")>-1?"&":"?";return e+r+o}(t,n,e);return a.open(e,s,!0),a.withCredentials=o.hasOwnProperty("withCredentials"),function(e,t,n){(function(e){return Object.keys(e).some((function(e){return"content-type"===e.toLowerCase()}))})(t=t||{})||(t["Content-Type"]=g(n)?"application/json":"application/x-www-form-urlencoded");Object.keys(t).forEach((function(n){t[n]&&e.setRequestHeader(n,t[n])}))}(a,o.headers,n),a.addEventListener("readystatechange",function(e,t){return function n(){t.readyState===t.DONE&&(t.removeEventListener("readystatechange",n,!1),e.always.apply(e,p(t)),t.status>=200&&t.status<300?e.then.apply(e,p(t)):e.catch.apply(e,p(t)))}}(r,a),!1),a.send(g(n)?JSON.stringify(n):n),r.abort=function(){return a.abort()},r}function p(e){var t;try{t=JSON.parse(e.responseText)}catch(n){t=e.responseText}return[t,e]}function g(e){return"[object Object]"===Object.prototype.toString.call(e)}function w(e){return encodeURIComponent(e)}!function(){try{new CustomEvent("IE has CustomEvent, but doesn't support constructor")}catch(e){window.CustomEvent=function(e,t){var n;t=t||{bubbles:!1,cancelable:!1,detail:void 0};return(n=document.createEvent("CustomEvent")).initCustomEvent(e,t.bubbles,t.cancelable,t.detail),n},CustomEvent.prototype=Object.create(window.Event.prototype)}}();return{version:"1.0.0",adaptive:n,device:o,modal:r,scrollTo:a.scrollTo,url:l,utils:u,ajax:f}}();
